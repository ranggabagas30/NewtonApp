...
public class ScannerOverlay extends ViewGroup {
    ...
    private float bLeftF, bTopF, bRightF, bBottomF;
    ...
    protected void onDraw(Canvas canvas) {
        ...
        background.setColor(Color.BLACK); // destination
        canvas.drawRect((float) bLeft, (float) bTop, (float) bRight, (float) bBottom, background);

        Paint eraser = new Paint();
        eraser.setAntiAlias(true); // source
